...
write.csv(Current_MLB, "C:/Users/agold/OneDrive/Desktop/AWS Project/Current_MLB.csv", row.names = F)
write.csv(Current_MiLB, "C:/Users/agold/OneDrive/Desktop/AWS Project/Current_MiLB.csv", row.names = F)
